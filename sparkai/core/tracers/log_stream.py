...
from sparkai.core.load import dumps
from sparkai.core.load.load import load
from sparkai.core.outputs import ChatGenerationChunk, GenerationChunk
from sparkai.core.runnables import Runnable, RunnableConfig, ensure_config
from sparkai.core.runnables.utils import Input, Output
from sparkai.core.tracers.base import BaseTracer
from sparkai.core.tracers.memory_stream import _MemoryStream
...
async def _astream_log_implementation(
    ...
    **kwargs: Any,
    ...
    from sparkai.core.callbacks.base import BaseCallbackManager

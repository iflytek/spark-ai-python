...
from sparkai.core.utils.json_schema import dereference_refs
...
@deprecated(
    "0.1.16",
    alternative="sparkai.core.utils.function_calling.convert_to_openai_function()",
    removal="0.2.0",
)
...
@deprecated(
    "0.1.16",
    alternative="sparkai.core.utils.function_calling.convert_to_openai_tool()",
    removal="0.2.0",
)

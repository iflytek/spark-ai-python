...
from sparkai.core.load import dumpd, dumps
...
from sparkai.core.runnables.config import ensure_config, run_in_executor

if TYPE_CHECKING:
    from sparkai.core.runnables import RunnableConfig
        ...
        if type(self)._stream == BaseChatModel._stream:
            ...
            try:
                for chunk in self._stream(
                    ...
                    yield {'content': chunk[0].message, 'token_usage': chunk[1]}
                    if generation is None:
                        generation = chunk[0]
                    else:
                        generation += chunk[0]

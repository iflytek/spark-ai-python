...
from sparkai.core.runnables.base import Runnable, RunnableSerializable
...
from sparkai.core.utils.aiter import py_anext

if TYPE_CHECKING:
    from sparkai.core.callbacks.manager import AsyncCallbackManagerForChainRun
...
class RunnableWithFallbacks(RunnableSerializable[Input, Output]):
    ...
    Example:
        ...
        .. code-block:: python
            ...
            from sparkai.core.chat_models.openai import ChatOpenAI
            from sparkai.core.chat_models.anthropic import ChatAnthropic
            ...
            from sparkai.core.output_parser import StrOutputParser

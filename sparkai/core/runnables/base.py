...
from sparkai.core._api import beta_decorator
from sparkai.core.load.dump import dumpd
from sparkai.core.load.serializable import Serializable
from sparkai.core.pydantic_v1 import BaseConfig, BaseModel, Field, create_model
from sparkai.core.runnables.config import (
    RunnableConfig,
...
from sparkai.core.runnables.graph import Graph
from sparkai.core.runnables.schema import EventData, StreamEvent
from sparkai.core.runnables.utils import (
    AddableDict,
...
from sparkai.core.utils.aiter import atee, py_anext
from sparkai.core.utils.iter import safetee
...
if TYPE_CHECKING:
    ...
    from sparkai.core.prompts.base import BasePromptTemplate
    from sparkai.core.runnables.fallbacks import (
    ...
    from sparkai.core.tracers.root_listeners import Listener
...
class Runnable(Generic[Input, Output], ABC):
    ...
    * Async: Methods with "a" suffix are asynchronous. By default, they execute
    ...
    .. code-block:: python
        ...
        from sparkai.core.runnables import RunnableLambda
    ...
    You can set the global debug flag to True to enable debug output for all chains:
        ...
        .. code-block:: python
            ...
            from sparkai.core.globals import set_debug
            set_debug(True)
    ...
    Alternatively, you can pass existing or custom callbacks to any given chain:
        ...
        .. code-block:: python
            ...
            from sparkai.core.tracers import ConsoleCallbackHandler
    ...
    def pick(self, keys: Union[str, List[str]]) -> RunnableSerializable[Any, Any]:
        ...
        from sparkai.core.runnables.passthrough import RunnablePick
    ...
    def assign(
        ...
        **kwargs: Union[
        ...
        Returns a new runnable."""
        from sparkai.core.runnables.passthrough import RunnableAssign
    ...
    def with_listeners(
        ...
        *,
        ...
        added to the run.
        """
        from sparkai.core.tracers.root_listeners import RootListenersTracer
    ...
    def with_retry(
        ...
        *,
        ...
        """
        from sparkai.core.runnables.retry import RunnableRetry
    ...
    def with_fallbacks(
        ...
        *,
        ...
        """
        from sparkai.core.runnables.fallbacks import RunnableWithFallbacks
    ...
    async def _atransform_stream_with_config(
        ...
        **kwargs: Optional[Any],
        ...
        from sparkai.core.tracers.log_stream import LogStreamCallbackHandler
...
class RunnableSerializable(Serializable, Runnable[Input, Output]):
    ...
    def configurable_fields(
        ...
        from sparkai.core.runnables.configurable import RunnableConfigurableFields
    ...
    def configurable_alternatives(
        ...
        **kwargs: Union[Runnable[Input, Output], Callable[[], Runnable[Input, Output]]],
        ...
        from sparkai.core.runnables.configurable import (
...
def _seq_input_schema(
    ...
    from sparkai.core.runnables.passthrough import RunnableAssign, RunnablePick
...
class RunnableSequence(RunnableSerializable[Input, Output]):
    ...
    Here's an example that uses streams JSON output generated by an LLM:
        ...
        .. code-block:: python
            ...
            from sparkai.core.output_parsers.json import SimpleJsonOutputParser
    ...
    @property
    def config_specs(self) -> List[ConfigurableFieldSpec]:
        from sparkai.core.beta.runnables.context import (
    ...
    def invoke(self, input: Input, config: Optional[RunnableConfig] = None) -> Output:
        from sparkai.core.beta.runnables.context import config_with_context
    ...
    async def ainvoke(
        ...
        **kwargs: Optional[Any],
        ...
        from sparkai.core.beta.runnables.context import aconfig_with_context
    ...
    def batch(
        ...
        **kwargs: Optional[Any],
        ...
        from sparkai.core.beta.runnables.context import config_with_context
        from sparkai.core.callbacks.manager import CallbackManager
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        from sparkai.core.beta.runnables.context import aconfig_with_context
        from sparkai.core.callbacks.manager import AsyncCallbackManager
...
class RunnableGenerator(Runnable[Input, Output]):
    ...
    Here is an example to show the basic mechanics of a RunnableGenerator:
        ...
        .. code-block:: python
            ...
            from sparkai.core.runnables import RunnableGenerator
...
class RunnableBinding(RunnableBindingBase[Input, Output]):
    ...
    `bind`: Bind kwargs to pass to the underlying runnable when running it.
        ...
        .. code-block:: python
            ...
            from sparkai.core.runnables import RunnableBinding
...
def chain(
    ...
    .. code-block:: python
        ...
        from sparkai.core.runnables import chain
        from sparkai.core.prompts import PromptTemplate

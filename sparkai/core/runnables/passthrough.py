...
from sparkai.core.pydantic_v1 import BaseModel, create_model
from sparkai.core.runnables.base import (
    Other,
    Runnable,
    RunnableParallel,
...
from sparkai.core.runnables.utils import AddableDict, ConfigurableFieldSpec
...
class RunnablePassthrough(RunnableSerializable[Other, Other]):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from sparkai.core.runnables import (
                RunnableLambda,
                RunnableParallel,
                RunnablePassthrough,
            )
    ...
    keys to the output. In this case, you can use the `assign` method:
        ...
        .. code-block:: python
            ...
            from sparkai.core.runnables import RunnablePassthrough, RunnableParallel

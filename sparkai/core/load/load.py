...
from sparkai.core._api import beta
from sparkai.core.load.mapping import (
...
DEFAULT_NAMESPACES = ["sparkai","sparkai.core", "langchain_core", "langchain_community"]
...
class Reviver:
    ...
    def __call__(self, value: Dict[str, Any]) -> Any:
        ...
        if (
            ...
            # The root namespace "sparkai" is not a valid identifier.
            if len(namespace) == 1 and namespace[0] == "sparkai":
                raise ValueError(f"Invalid namespace: {value}")

...
from sparkai.core.pydantic_v1 import Extra, Field
from sparkai.core.utils import get_bolded_text
from sparkai.core.utils.interactive_env import is_interactive_env

if TYPE_CHECKING:
    from sparkai.core.prompts.chat import ChatPromptTemplate
...
class BaseMessage(Serializable):
    ...
    def __add__(self, other: Any) -> ChatPromptTemplate:
        from sparkai.prompts.chat import ChatPromptTemplate
